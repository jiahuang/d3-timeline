            ...
            if (ending == 0 && beginning == 0) {
                g.each(function (d, i) {
                    d.forEach(function (datum, index) {
                        ...
                        // if not stacking then labels appear items
                        // if stacked, labels appear on the left
                        if (stacked) {
                    ...
                    if (hasLabel) {
                        ...
                        gParent.append('text')
                            ...
                            .attr("transform", function(d,i) {
                                if (stacked) {
                                    return  "translate("+ 0 +","+ (itemHeight/2 + margin.top + (itemHeight + itemMargin) * yAxisMapping[index])+")";
                                } else {
                                    return  "translate("+ String(getXPos(datum['times'][0],i)) +","+ (itemHeight/2 + margin.top + (itemHeight + itemMargin) * yAxisMapping[index])+")";
                                }
                            })
